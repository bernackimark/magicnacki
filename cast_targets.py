...
CAST_TARGETS = {
    ...
    'raise-dead': lambda gs: CardFilter(gs).in_player_graveyard(gs.player_turn_idx).creatures().result(),
    'reconstruction': lambda gs: CardFilter(gs).in_player_graveyard(gs.player_turn_idx).artifacts().result(),
    'regrowth': lambda gs: CardFilter(gs).in_player_graveyard(gs.player_turn_idx).result(),
    'resurrection': lambda gs: CardFilter(gs).in_player_graveyard(gs.player_turn_idx).creatures().result(),
