...
MAP: dict[str: list[EffSpec]] = {
    ...
    'fire-sprites': [Activated('GT', AddMana('R'), T_FUNCS['owner'], is_mana_ability=True)],
    'firebreathing': [Spell(EmptyResolver(), T_FUNCS['creatures']), self_pump('R', 1, 0)],
    'firestorm-phoenix': [Triggered(FirestormPhoenix())],
    'fishliver-oil': [Spell(KWAModEffect('add', KW.ISLANDWALK), T_FUNCS['creatures'])],
    ...
    'flight': [Spell(KWAModEffect('add', KW.FLYING), T_FUNCS['creatures'])],
    'flood': [Activated('UU', TapCardEffect(), T_FUNCS['untapped_creatures_without_flying'])],
    'floral-spuzzem': [Triggered(FloralSpuzzem())],
    'flying-carpet': [Activated('2T', KWAModEffect('add', KW.FLYING, True), T_FUNCS['creatures'])],
    ...
    'gaeas-touch': [Activated('', AddMana('G', 2), T_FUNCS['owner'], is_mana_ability=True, extra_costs=[SacSelfCost()],
                              text='Exile for {GG}'),
    ...
    'goblin-balloon-brigade': [Activated('R', KWAModEffect('add', KW.FLYING, True), T_FUNCS['self'])],
    ...
    'goblin-wizard': [Activated('T', HandToBoard(), T_FUNCS['goblin_permanents_in_your_hand']),
                      Activated('T', KWAModEffect('add', KW.PROTECTION_FROM_WHITE, True), T_FUNCS['goblins'])],
    ...
    'gravity-sphere': [Static(KWAApplies(T_FUNCS['creatures'], 'remove', KW.FLYING))],
    ...
    'green-ward': [Spell(KWAModEffect('add', KW.PROTECTION_FROM_GREEN), T_FUNCS['creatures'])],
    'guardian-angel': [Spell(GuardianAngel(), T_FUNCS['all_creatures_and_players'])],  # partial
    'guardian-beast': [Static(KWAApplies(T_FUNCS['your_non_creature_artifacts'], 'add', KW.INDESTRUCTIBLE,
    ...
    'hammerheim': [Activated('T', AddMana('R'), T_FUNCS['owner'], is_mana_ability=True),
    ...
    'hells-caretaker': [Activated('T', Reanimate(), T_FUNCS['creatures_in_your_graveyard'],
                                  ...
                                  extra_costs=SacCardCost(T_FUNCS['your_creatures']))],
    'hidden-path': [Static(KWAApplies(T_FUNCS['green_creatures'], 'add', KW.FORESTWALK))],
    ...
    'instill-energy': [Spell(KWAModEffect('add', KW.HASTE), T_FUNCS['creatures']),
    ...
    'jump': [Spell(KWAModEffect('add', KW.FLYING, True), T_FUNCS['creatures'])],
    'junun-efreet': [Triggered(PayManaOrSacAtUpkeep('BB'))],
    'juzam-djinn': [Triggered(DealDamageToOwnerOnUpkeep(1), T_FUNCS['self'])],
    'karakas': [Activated('T', AddMana('W'), is_mana_ability=True),
                Activated('T', Bounce(), T_FUNCS['legendary_creatures'])],
    ...
    'kobold-overlord': [Static(KWAApplies(T_FUNCS['your_other_kobolds'], 'add', KW.FIRST_STRIKE))],
    ...
    'lance': [Spell(KWAModEffect('add', KW.FIRST_STRIKE), T_FUNCS['creatures'])],
    ...
    'llanowar-elves': [Activated('T', AddMana('G'), T_FUNCS['owner'], is_mana_ability=True)],
    'lord-of-atlantis': [Static(PumpApplies(T_FUNCS['other_merfolk'], (1, 1))),
                         Static(KWAApplies(T_FUNCS['other_merfolk'], 'add', KW.ISLANDWALK))],
    ...
    'mana-vault': [Triggered(DoesntUntapAtUntap(T_FUNCS['self'])),
                   ...
                   Activated('T', AddMana('C', 3), T_FUNCS['owner'], is_mana_ability=True),
    ...
    'mishras-factory': [Activated('T', AddMana('C'), T_FUNCS['owner'], is_mana_ability=True, text='Add {C}'),
