...
MAP: dict[str, list[EffSpec]] = {
    ...
    'psychic-allergy': [Triggered(PsychicAllergySac(), T_FUNCS['self']),
                        Triggered(PsychicAllergyDamage()), Triggered(DeclareAColor(), None, CastResolvedEvent)],
    'psychic-purge': [Triggered(DealDamage(1), T_FUNCS['all_creatures_and_players'], CastResolvedEvent),
                      Triggered(PsychicPurgeDiscard())],
    'psychic-venom': [Triggered(None, T_FUNCS['lands'], CastResolvedEvent), Triggered(PsychicVenom())],
    ...
    'rock-hydra': [Triggered(RockHydraCast(), T_FUNCS['self'], CastResolvedEvent),
                   Triggered(RockHydraAutoDamagePrevent()),
    ...
    'shapeshifter': [Triggered(Shapeshifter(), None, CastResolvedEvent), Triggered(Shapeshifter())],
    ...
    'spirit-shackle': [Triggered(None, T_FUNCS['creatures'], CastResolvedEvent), Triggered(SpiritShackle())],
    ...
    'vesuvan-doppelganger': [Triggered(VesuvanDoppelgangerCast(), None, CastResolvedEvent),
                             Triggered(VesuvanDoppelgangerUpkeep())],
    ...
    'wanderlust': [Triggered(None, T_FUNCS['creatures'], CastResolvedEvent),
                   Triggered(DealDamageOnHostUpkeep(1), T_FUNCS['host_owner'])],
