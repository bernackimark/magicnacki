...
MAP: dict[str, list[EffSpec]] = {
    ...
    'part-water': [Spell(KWAModEffect('add', KW.ISLANDWALK, True), TF.creatures(),
    ...
    'rapid-fire': [Spell(RapidFire(), TF.creatures(),
    ...
    'rasputin-dreamweaver': [Activated('', AddMana('C'), is_mana_ability=True, extra_costs=[RemoveCounterCost(DREAM)]),
                             Activated('', PreventNextDamageTo(1), TF.self(),
    ...
    'red-elemental-blast': [Spell(CounterSpell(), TF.blue_spells()),
                            Spell(Destroy(), TF.blue_permanents())],
    ...
    'reset': [Spell(Reset(), allowed_p_turn_func=TF.opp(),
    ...
    'rock-hydra': [Static(RockHydraAutoDamagePrevent()),
                   Activated('R', PreventNextDamageTo(1), TF.self()),
    ...
    'rubinia-soulsinger': [Activated('T', Steal(return_on_untap=True), TF.opp_creatures()),
    ...
    'sage-of-lat-nam': [Activated('T', DrawCards(), TF.owner(),
    ...
    'shimian-night-stalker': [Activated('BT', RedirectNextDamageToTarget(TF.owner(), TF.self()),
                                        TF.opp_attackers())],
    ...
    'tawnoss-weaponry': [Triggered(OptionalUntap()),
                         ...
                         (Triggered(UntapRemovesPumpFromAnotherCard()))],
    ...
    'tormods-crypt': [Activated('T', GraveyardToExileInItsEntirety(), TF.all_players(),
    ...
    'triskelion': [Activated('', DealDamage(1), TF.all_creatures_and_players(),
    ...
    'unstable-mutation': [Static(AddCounterAtTargetUpkeep(TF.host(), MINUS_ONE)),
    ...
    'willow-satyr': [Activated('T', Steal(return_on_untap=True), TF.opp_legendary_creatures()),
    ...
    'witch-hunter': [Activated('T', DealDamage(1), TF.all_players()),
                     Activated('1WWT', Bounce(), TF.opp_creatures())],
