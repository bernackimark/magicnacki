...
MAP: dict[str, list[EffSpec]] = {
    ...
    'pendelhaven': [Activated('T', AddMana('G'), T_FUNCS['owner'], is_mana_ability=True),
    ...
    'phyrexian-gremlins': [Triggered(OptionalUntap()), Activated('T', PhyrexianGremlinsTap(), T_FUNCS['artifacts']),
    ...
    'sisters-of-the-flame': [Activated('T', AddMana('R'), T_FUNCS['owner'], is_mana_ability=True)],
    ...
    'sol-ring': [Activated('T', AddMana('C', 2), T_FUNCS['owner'], is_mana_ability=True)],
    ...
    'strip-mine': [Activated('T', AddMana('C'), T_FUNCS['owner'], is_mana_ability=True),
