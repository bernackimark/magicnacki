...
MAP: dict[str, list[EffSpec]] = {
    ...
    'apprentice-wizard': [Activated('UT', AddMana('C', 3), T_FUNCS['owner'], is_mana_ability=True)],
    ...
    'basalt-monolith': [Triggered(DoesntUntapAtUntap(T_FUNCS['self'])),
                        ...
                        Activated('3', UntapCardEffect(), T_FUNCS['self'])],
    ...
    'celestial-prism': [Activated('2T', AddMana(c), T_FUNCS['owner'], is_mana_ability=True, text=f'Add 1 {c}')
                        for c in COLOR_LETTERS],
    ...
    'clone': [Spell(Clone())],
    'coal-golem': [Activated('3', AddMana('R', 3), T_FUNCS['owner'], is_mana_ability=True
                             , extra_costs=[SacSelfCost()])],
    ...
    'elephant-graveyard': [Activated('T', AddMana('C'), is_mana_ability=True),
                           Activated('T', Regenerate(), T_FUNCS['elephants'])],
