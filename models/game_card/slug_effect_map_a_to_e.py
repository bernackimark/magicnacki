...
MAP: dict[str, list[EffSpec]] = {
    ...
    'al-abaras-carpet': [Activated('5T', PreventAllDamageEOT(T_FUNCS['owner'], T_FUNCS['non_fliers'], True))],
    ...
    'circle-of-protection-artifacts': [Activated('1', PreventNextDamageTo(protected=T_FUNCS['owner']), T_FUNCS['artifacts'])],
    'circle-of-protection-black': [Activated('1', PreventNextDamageTo(protected=T_FUNCS['owner']), T_FUNCS['black'])],
    'circle-of-protection-blue': [Activated('1', PreventNextDamageTo(protected=T_FUNCS['owner']), T_FUNCS['blue'])],
    'circle-of-protection-green': [Activated('1', PreventNextDamageTo(protected=T_FUNCS['owner']), T_FUNCS['green'])],
    ...
    'clockwork-beast': [Static(ClockworkCombatEnd()),
                        Activated('XT', AddCounter(PLUS_ONE_ZERO), T_FUNCS['self'], allowed_phases=[Phase.UPKEEP],
                                  allowed_p_turn_func=T_FUNCS['owner'], max_x_func=clockwork_beast_x),
                        Spell(AddCounter(PLUS_ONE_ZERO, 7))],
    'clone': [Spell(Clone())],
    'coal-golem': [Activated('3', AddMana('R', 3), T_FUNCS['owner'], extra_costs=[SacSelfCost()])],
    ...
    'electric-eel': [Spell(DealDamage(1), T_FUNCS['owner']), Activated('RR', ElectricEel())],
