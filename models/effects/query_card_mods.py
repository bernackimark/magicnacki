...
class AddCreatureType(Effect):
    ...
    query = ('type_mod', 'sub_type_mod', 'pt_mod')
    ...
    def query_mods(self, gs: GameState, query: str, card: GameCard, source: GameCard, **kwargs) -> ModType | list[ModType] | None:
